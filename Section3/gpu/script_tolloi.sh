...
cd /u/dssc/tolloi/Assignment1-HPC2021/Section3/gpu
...
mpirun --mca btl ^openib -np 24 --map-by socket ./jacoby3D.x <input.1200

echo "Two nodes 48 cores"
mpirun --mca btl ^openib -np 48 --map-by socket ./jacoby3D.x <input.1200
